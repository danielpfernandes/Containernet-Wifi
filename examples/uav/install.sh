...
if [[ $distro == "Ubuntu" ]]; then # replace 8.04 by the number of release you want
		...
		if [[ $release == "20.10" || $release == "20.04" || $release == "18.10" || r$elease == "18.04" ]]; then # replace 8.04 by the number of release you want
			...
			cd ../../
		elif [[ $release == "18.04" || $release == "18.10" ]]; then
			echo "Downloading CoppeliaSim"
			cd examples/uav/
			wget https://www.coppeliarobotics.com/files/CoppeliaSim_Edu_V4_3_0_Ubuntu18_04.tar.xz
			tar -xJf CoppeliaSim_Edu_V4_3_0_Ubuntu18_04.tar.xz
			mv CoppeliaSim_Edu_V4_3_0_Ubuntu18_04 CoppeliaSim_Edu_V4_1_0_Ubuntu
			rm CoppeliaSim_Edu_V4_1_0_Ubuntu18_04.tar.xz
			cd ../../
		else 

...
def topology():
    ...
    "Create a network."
    net = net = Containernet()

    info("*** Creating nodes\n")
    dr1 = net.addStation('dr1', cls=DockerSta, dimage="ubuntu:trusty", mac='00:00:00:00:00:01', ip='10.0.0.1/8',
                         position='30,60,0')
    dr2 = net.addStation('dr2', cls=DockerSta, dimage="ubuntu:trusty", mac='00:00:00:00:00:02', ip='10.0.0.2/8',
                         position='70,30,0')
    dr3 = net.addStation('dr3', cls=DockerSta, dimage="ubuntu:trusty", mac='00:00:00:00:00:03', ip='10.0.0.3/8',
                         position='10,20,0')
